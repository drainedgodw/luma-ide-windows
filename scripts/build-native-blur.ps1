...
& $compiler.Source /nologo /std:c++17 /permissive- /O2 /W4 /WX /EHsc /guard:cf /DUNICODE /D_UNICODE $source "/Fo:$object" "/Fe:$output" /link /DYNAMICBASE /NXCOMPAT /guard:cf user32.lib
